...
The scenarios are generated using data from the Jet Propulsion Laboratory of NASA and handled used the `jplephem` package. Description of the package and the data source are detailed [here](https://pypi.org/project/jplephem/).
