...
This repo contains the code for handling interplanetary trajectory planning for rendez-vous missions in the solar system.
...
We use the MGA model described to calculate velocities of the spacecraft by solving the Lambert equation [1]. The code for this model was generated with the help of Claude LLM from Anthropic.
...
## References
[1] Song, Yuqi, et al. "Gravity assist space pruning and global optimization of spacecraft trajectories for solar system boundary exploration." Complex & Intelligent Systems 10.1 (2024): 323-341. [Paper](https://link.springer.com/content/pdf/10.1007/s40747-023-01123-2.pdf)
[2] Hennes, Daniel, and Dario Izzo. "Interplanetary Trajectory Planning with Monte Carlo Tree Search." IJCAI. 2015. [Paper](https://www.esa.int/gsp/ACT/doc/AI/pub/ACT-RPR-AI-2015-IJCAI-mcts.pdf)